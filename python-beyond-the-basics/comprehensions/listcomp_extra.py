...
combos = ["{} {}".format(color, garment) for color in colors for garment in garments]

brief_combos = ["{} {}".format(color, garment) for color in colors for garment in garments if not garment.find(" ") != -1]
